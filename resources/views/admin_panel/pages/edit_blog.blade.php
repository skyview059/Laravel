...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content" >
           ...
           {!! Form::open(array('url'=>'save-blog', 'role'=>'form', 'method'=>'POST')) !!}
                <fieldset>
...
document.forms['edit_product'].elements['manufacturer_id'].value='';
document.forms['edit_product'].elements['category_id'].value='';
document.forms['edit_product'].elements['publication_status'].value='';
</script>
@stop